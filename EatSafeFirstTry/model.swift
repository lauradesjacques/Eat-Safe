...
var saladLentilles: Recette = Recette(nomRecette: "Salade de Lentilles", utilisateur: saquetoH, dateRecette: DateFormatYoko(jour: 04, mois: 11, anne: 2020), like: 0, commentaires: [commentLauraSaladLentilles], photoChallenge:  "imageSaladLentilles", ingredientsChallenger: [lentille,bouquetGarni,carotte,ail,sel,poivre,oignon], recette: "Tremper les lentilles 2h avant. \n Emincer les carottes et l'oignon. \n Cuire les lentilles à feu doux 1h30 avec le bouquet garni, les carottes, l'oignon et l'ail. \n Salé le tout en fin de cuisson.")

var clafoutis: Recette = Recette(nomRecette: "Clafoutis aux cerises", utilisateur: billgates, dateRecette: DateFormatYoko(jour: 24, mois: 1, anne: 2000), like: 766, commentaires: [commentJuanjoClafoutis], photoChallenge:  "clafoutis", ingredientsChallenger: [butter,oeuf,lait,farine,sugar,cerise])

var parisBrest : Recette = Recette(nomRecette: "Paris Brest", utilisateur: billgates, dateRecette: DateFormatYoko(jour: 12, mois: 4, anne: 2005), like: 344, commentaires: [commentNourhenParisBrest], photoChallenge:  "paris brest", ingredientsChallenger: [lait,butter,maizena,praline,oeuf,sugar])
...
var saladeDeFruit : Recette = Recette(nomRecette: "Salade de fruits", utilisateur: billgates, dateRecette: DateFormatYoko(jour: 12, mois: 7, anne: 2001), like: 45, commentaires: [], photoChallenge:  "salade de fruits", ingredientsChallenger: [fraise,citron,cerise,pomme])
...
var pomme = Ingredient(nomIngredient: "pomme", quantiteIngredient: 3, unitIngredient: "pcs", nutritionIngredient: "Vitamin C rich")
...
var cerise = Ingredient(nomIngredient:"Cerises",quantiteIngredient: 200,unitIngredient: "g")
...
var banane = Ingredient(nomIngredient: "banen", quantiteIngredient: 1, unitIngredient: "", nutritionIngredient: "", detailIngredient: "")
/* laura a modifié et ajouté Ingredient de recette */
...
let commentLauraSaladLentilles = Commentaire(profileCommentaire: lauraD, dateCommentaire: DateFormatYoko(jour: 04, mois: 11, anne: 22), commentaire: "Fantastique!")
...
var listProfiles: [Profile] = [yokoM, lauraD, saquetoH, billgates]

/* List Recette*/

var listRecettes: [Recette] =  [tarteTatin, saladLentilles, pastaBolognese, gratinDauphinois, clafoutis, parisBrest, tarteCitronMeringuee, saladeDeFruit, millefeuille, fondantChocolat]
...
//-----------------------------------------------------------------------------
var legumeVert = ChallengeDeJour(nomDuChallenge: "Challenge légumes verts", listIngredients: [infoArtichat,infoAsperge,infoBrocoli,infoCéleri,infoKiwi], collectionDeChallenge:[], imageDuChallenge: "legumevert")

var legumeJaune = ChallengeDeJour(nomDuChallenge: "Challenge fruits et légumes jaunes", listIngredients: [infoAnanas,infoMelon,infoBanana,infoMangue,infoPapaya,infoPassion,infoCarotte], collectionDeChallenge: [], imageDuChallenge: "legumejaune")

var fruitRouge = ChallengeDeJour(nomDuChallenge: "Challenge fruits rouges", listIngredients: [infoStrawberry,infoRaspberry,infoBlueberry,infoBlackberry, infoBetterave], collectionDeChallenge: [], imageDuChallenge: "fruitrouge")

var mure = ChallengeDeJour(nomDuChallenge: "Challenge mûres et myrtilles", listIngredients: [infoBlueberry,infoBlackberry,infoAubergine], collectionDeChallenge: [], imageDuChallenge: "mureetmyrtille")
...
/* today's date */
var dateToday: DateFormatYoko = DateFormatYoko(jour: 11, mois: 11, anne: 2020)
